...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(uniCloud) {\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n\nvar system = uni.getSystemInfoSync();\nvar app = getApp();\nvar _default = {\n  data: function data() {\n    return {\n      publichTouched: false,\n      preplayTouched: false,\n      // tempCover: \"/static/face/face-arrow-1.png\",\n      tempFilePath: \"\",\n      videoUrl: \"\",\n      tempCover: \"\",\n      title: \"\",\n      width: 0,\n      height: 0,\n      percentCompleted: 0\n    };\n  },\n  onLoad: function onLoad(params) {\n    var me = this;\n    this.statusBarHeight = system.statusBarHeight;\n    this.screenWidth = system.screenWidth;\n\n    // 上个页面传过来的文件事件对象，其中包含了相册中选择的视频内容\n    var fileObjectEvent = JSON.parse(params.fileObjectEvent);\n    var times = new Date().getTime();\n    uniCloud.uploadFile({\n      filePath: fileObjectEvent.tempFilePath,\n      cloudPath: times + '.mp4',\n      onUploadProgress: function onUploadProgress(progressEvent) {\n        var percentCompleted = Math.round(progressEvent.loaded * 100 / progressEvent.total);\n        me.percentCompleted = percentCompleted;\n      },\n      success: function success(f) {\n        var videoUrlTemp = f.filePath;\n        var videoUrl = f.fileID;\n\n        // 获得视频参数\n        me.tempFilePath = videoUrlTemp;\n        me.videoUrl = videoUrl;\n        me.tempCover = videoUrl + \"?x-oss-process=video/snapshot,t_1,f_jpg,ar_auto\"; // 截帧\n        me.width = fileObjectEvent.width;\n        me.height = fileObjectEvent.height;\n      }\n    });\n  },\n  methods: {\n    typingContent: function typingContent(e) {\n      var event = e;\n      this.title = e.detail.value;\n    },\n    doPublich: function doPublich() {\n      var me = this;\n      var userId = getApp().getUserInfoSession().id;\n      var vlog = {\n        \"vlogerId\": userId,\n        \"url\": me.videoUrl,\n        \"cover\": me.tempCover,\n        \"title\": me.title,\n        \"width\": me.width,\n        \"height\": me.height\n      };\n\n      // 发布视频\n      var serverUrl = app.globalData.serverUrl;\n      uni.request({\n        method: \"POST\",\n        header: {\n          headerUserId: userId,\n          headerUserToken: app.getUserSessionToken()\n        },\n        url: serverUrl + \"/vlog/publish\",\n        data: vlog,\n        success: function success(result) {\n          if (result.data.code == \"0\") {\n            uni.showToast({\n              title: \"发布成功！\",\n              icon: \"none\"\n            });\n            uni.navigateBack({\n              delta: 1,\n              animationType: 'zoom-fade-in',\n              animationDuration: 1000\n            });\n            uni.switchTab({\n              url: \"../me/me\"\n            });\n          } else {\n            uni.showToast({\n              title: result.data.message,\n              icon: \"none\",\n              duration: 3000\n            });\n          }\n        }\n      });\n    },\n    preview: function preview() {\n      uni.navigateTo({\n        url: \"/pages/publish/preview?videoUrl=\" + this.videoUrl + \"&width=\" + this.width + \"&height=\" + this.height,\n        animationType: 'slide-in-bottom',\n        animationDuration: 500\n      });\n    },\n    touchstartPreplay: function touchstartPreplay() {\n      this.preplayTouched = true;\n    },\n    touchendPreplay: function touchendPreplay() {\n      this.preplayTouched = false;\n    },\n    touchstartPublich: function touchstartPublich() {\n      this.publichTouched = true;\n    },\n    touchendPublich: function touchendPublich() {\n      this.publichTouched = false;\n    },\n    chooseCover: function chooseCover() {\n      var me = this;\n      var userId = getApp().getUserInfoSession().id;\n      uni.chooseImage({\n        count: 1,\n        sourceType: ['album'],\n        success: function success(e) {\n          me.tempCover = e.tempFilePaths[0];\n\n          // 上传封面\n          var serverUrl = app.globalData.serverUrl;\n          uni.uploadFile({\n            url: serverUrl + \"/file/uploadImage?userId=\" + userId,\n            name: \"file\",\n            filePath: me.tempCover,\n            success: function success(result) {\n              var res = JSON.parse(result.data);\n              if (res.status == 200) {\n                var imageUrl = res.data;\n                me.tempCover = imageUrl;\n              } else {\n                uni.showToast({\n                  title: result.data.message,\n                  icon: \"none\",\n                  duration: 3000\n                });\n              }\n            }\n          });\n        }\n      });\n    }\n  }\n};\nexports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/uni-cloud/dist/index.js */ 161)[\"uniCloud\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///160\n");
...
var _slicedToArray2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ 166));
...
var N = "";
try {
  N = (__webpack_require__(/*! uni-stat-config */ 188).default || __webpack_require__(/*! uni-stat-config */ 188)).appid;
} catch (e) {}
var R,
  L = {};
function U(e) {
...
var Zs = Xs;
exports.default = Zs;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-hbuilderx/packages/uni-app-plus-nvue/dist/require-native-plugin.js */ 162)["default"]))
...
var arrayWithHoles = __webpack_require__(/*! ./arrayWithHoles.js */ 167);
var iterableToArrayLimit = __webpack_require__(/*! ./iterableToArrayLimit.js */ 168);
var unsupportedIterableToArray = __webpack_require__(/*! ./unsupportedIterableToArray.js */ 169);
var nonIterableRest = __webpack_require__(/*! ./nonIterableRest.js */ 171);
...
/* 187 */
/*!****************************************************************************!*\
  !*** D:/project/Dousheng/frontend/pages.json?{"type":"origin-pages-json"} ***!
  \****************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
